# Capability: HTTP/2 Standard Library Client Transport

## Purpose

This capability provides a performant and maintainable HTTP/2 client transport using Go's standard library `net/http` package, replacing the legacy and unmaintained `hertz-contrib/http2` implementation.
